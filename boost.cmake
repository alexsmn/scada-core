...
if(WIN32)
  ...
  math(EXPR MSVC_TOOLSET "${MSVC_VERSION} / 10 - 50")
  set(BOOST_DEBUG_SUFFIX "vc${MSVC_TOOLSET}-mt-gd-${BOOST_ARCH}-${Boost_MAJOR_VERSION}_${Boost_MINOR_VERSION}")
  set(BOOST_RELEASE_SUFFIX "vc${MSVC_TOOLSET}-mt-${BOOST_ARCH}-${Boost_MAJOR_VERSION}_${Boost_MINOR_VERSION}")

  foreach(BOOST_COMPONENT ${BOOST_COMPONENTS})
    if(NOT ${BOOST_COMPONENT} MATCHES "atomic|context|date_time|json|program_options")
      install(FILES
